...
time_vector = np.linspace(0.,resample_steps*delta_t*ntsteps,ntsteps)
tau_vector = time_vector*2*v_inf/chord

heave_input_int = 1e0*gen_disp[0,:]*0.106654261 # heave input if you want to convert to m
time_heave = np.linspace(0.,delta_t*len(heave_input_int),len(heave_input_int))
...
plt.plot(tau_vector,cm_output_print,".-",label=r"$C_m$")
plt.xlabel(r'$\tau\,[\,]$')
plt.ylabel(r'$C_m\, [\,]$')
plt.legend()
plt.grid(True)
...
plt.plot(tau_vector,cl_output_print,label=r"$C_l$")
plt.xlabel(r'$\tau\,[\,]$')
plt.ylabel(r'$C_l\, [\,]$')
plt.legend()
plt.grid(True)
...
plt.plot(time_vector,heave_input*180/np.pi,label="heave input")
plt.xlabel(r'$t\,[s]$')
...
plt.plot(time_vector,(pitch_input + heave_input)*180/np.pi,label="pitch input")
plt.xlabel(r'$t\,[s]$')
...
for icolumn in range(m):
    ...
    A_thetadot[icolumn:,icolumn] = thetadot_input[:ntsteps-icolumn]
...
# plt.title("LAMBDA = "+str(eigvals[0]))
plt.plot(tau_vector,cl_output_print,label="Cl CFD")
plt.plot(tau_vector,cltest_check,label="Cl kernel 1")
plt.plot(tau_vector,cltest_check2,label="Cl kernel 2")
plt.xlabel(r'$\tau\,[\,]$')
plt.ylabel(r'$C_l\, [\,]$')
...
plt.plot(tau_vector,cm_output_print,label="Cm CFD")
plt.plot(tau_vector,cmtest_check,label="Cm kernel 1")
plt.plot(tau_vector,cmtest_check2,label="Cm kernel 2")
plt.xlabel(r'$\tau\,[\,]$')
plt.ylabel(r'$C_m\, [\,]$')
